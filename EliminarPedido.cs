    ...
    public partial class EliminarPedido : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DialogResult resultadoConfirmacion = MessageBox.Show("¿Está seguro de que desea eliminar este pedido?",
                ...
                {
                    string resultado = coBD.eliminarPedido(int.Parse(txtnumPe.Text));
                    CargarPedidos();
                    limpiarCampos();
                }
            }
