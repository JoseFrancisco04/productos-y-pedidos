    ...
    public partial class EliminarProducto : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DialogResult resultadoConfirmacion = MessageBox.Show("¿Está seguro de que desea eliminar este producto?",
                ...
                {
                    string resultado = coBD.eliminarProducto(int.Parse(txtCodigoB.Text));
